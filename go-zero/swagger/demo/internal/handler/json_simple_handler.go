...
func jsonSimpleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.JsonReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewJsonSimpleLogic(r.Context(), svcCtx)
		resp, err := l.JsonSimple(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
